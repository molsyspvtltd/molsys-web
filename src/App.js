    ...
    <React.Fragment>
      ...
      <HashRouter>
        <Switch>
          ...
          <Route path="/wellnessAssessment" component={WellnessAssessment} />
          <Route
            path="/WholeGenomeSequencing"
            component={WholeGenomeSequencing}
          />
          <Route path="/rnaSequencing" component={rnaSequencing} />
          <Route
            path="/MetagenomeAnalysisPage"
            component={MetagenomeAnalysisPage}
          />
          <Route path="/SmallRNASeqPage" component={SmallRNASeqPage} />
          <Route path="/ChIPSeqPage" component={ChIPSeqPage} />
          <Route
            path="/WholeGenomeReSeqPage"
            component={WholeGenomeReSeqPage}
          />
          <Route
            path="/WholeExomeAnalysisPage"
            component={WholeExomeAnalysisPage}
          />
          <Route
            path="/BiocloudServicesPage"
            component={BiocloudServicesPage}
          />
          <Route path="/SampleIsolationPage" component={SampleIsolationPage} />
          <Route path="/WholeGenomeSeqGen" component={WholeGenomeSeqGen} />
          <Route
            path="/SMetagenomeSequencing"
            component={SMetagenomeSequencing}
          />
          <Route
            path="/ITSMetagenomeSequencing"
            component={ITSMetagenomeSequencing}
          />
          <Route
            path="/GenotypingbySequencing"
            component={GenotypingbySequencing}
          />
          <Route
            path="/Agrigenotyping"
            component={Agrigenotyping}
            auth={isLoggedIn}
          />
          <Route path="/LivestockGenotyping" component={LivestockGenotyping} />
          <Route path="/PetGenotyping" component={PetGenotyping} />
          ...
          <Route path="/HumanArrays" component={HumanArrays} />
          <Route
            path="/MetaTranscriptomeAnalysisPage"
            component={MetaTranscriptomeAnalysisPage}
          />
          <Route path="/OligosForm" component={OligosForm} />
          <Route path="/DataGenerationform" component={DataGenerationform} />
          <Route path="/DataAnalysisform" component={DataAnalysisform} />
